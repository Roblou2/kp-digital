...
<h2 className='text-3xl md:text-4xl xl:text-6xl'>Contact Me
</h2>
...
<p className="pt-6 text-xl md:text-3xl lg:w-[80%]">
    I typically respond to enquiries within
    24 hours.</p>
 
<div className="flex flex-row  
contact font-barlow py-2"> <p className='text-xl 
md:text-2xl lg:text-4xl text-white'>hello@ano1webs.com</p>
</div>
