  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-16 md:gap-24 md:flex-row md:items-start">
          ...
          <div className="md:w-[40%] w-[100%]">
            <p className="mb-4 text-sm font-medium uppercase tracking-[0.35em] text-slate-200">
              Contact
            </p>

            <h2 className="text-4xl md:text-5xl font-semibold leading-tight text-slate-100">
      ...
      hello@killerperformancedigital.com
          ...
          <div className="md:w-[60%]">
            ...
            onSubmit={handleSubmit}
              className="
                rounded-2xl border border-slate-200 bg-zinc-50
                p-6 md:p-8
            ...
            >
              {/* Name */}
              <div className="mb-5">
                <label className="block text-md md:text-lg font-medium text-slate-900">
                ...
                <input
                  ...
                  required
                  className="
                    mt-2 block w-full rounded-md border border-slate-200 bg-slate-900
                    px-3 py-2 text-md md:text-lg text-slate-900 placeholder:text-slate-100
     ...
     focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500
              ...
              <div className="mb-6">
  <label className="flex items-start gap-3 text-sm md:text-base text-slate-900">
    <input
      type="checkbox"
      name="gdprConsent"
      required
