...
const LayoutBlogPost = ({children, title}) => {
    ...
    >
      ...
      <li>
        ...
        >
          ...
          <div className="absolute text-left top-[25rem] left-[50%]">
                  
  
          <h2 className="font-sans font-semibold text-white
           text-5xl relative left-[-50%] uppercase">
        {title}
              </h2>
      ...
      <li>
        ...
        >
          Copywriting services
            ...
            <div className="absolute text-left top-[24rem] left-[50%]">
...
fill={true}
    ...
    <div className="absolute text-left top-[14rem] left-[50%]">
 
    
          <h2 className="font-sans uppercase
          font-semibold text-white
          relative left-[-50%] mt-[-1rem]
           text-2xl">
{title}
              </h2>
      ...
      <main className="md:mt-[-2rem]">
               ...
               px-[15%]
               bg-black w-[100%] bg-[url('/images/footer-desktops-xl.png')] py-24">
...
font-barlow"> 
  ...
  hello@ano1webs.com</p>
               ...
               px-[10rem] xl:hidden
               bg-center   bg-black bg-cover bg-black bg-no-repeat bg-[url('/images/footer-desktops-xl.png')] w-[100%] py-32">
...
border-t border-dashed border-white"></div>
      ...
      <div className="flex flex-col flex-nowrap">
<p className="text-sm text-white font-barlow py-2">© A1 webs 2026</p>
